...
rm -R /opt/sherlock/google-chrome-stable_current_amd64.deb
...
rm -R /opt/sherlock/tor-browser-linux-x86*.tar.xz
cd /opt/sherlock/tor-browser
...
sleep 5
pkill -f firefox
mkdir /opt/sherlock/firefox
unzip $SCRIPT_DIR/firefox.zip -d /opt/sherlock/firefox
\cp -R /opt/sherlock/firefox/* ~/.mozilla/firefox/*.default-esr
rm -R /opt/sherlock/firefox
...
pkill --oldest chrome
mkdir /opt/sherlock/chrome
mkdir -p ~/.config/google-chrome
unzip $SCRIPT_DIR/chrome.zip -d /opt/sherlock/chrome
cp -R /opt/sherlock/chrome/* ~/.config/google-chrome
rm -R /opt/sherlock/chrome
...
mkdir  /opt/sherlock/maltego && cd  /opt/sherlock/maltego
...
rm /opt/sherlock/maltego/Maltego.v4.4.1.deb
echo -e "$VERDE Maltego Installed $RC"
 

echo -e "$AZUL3 Installing Google Earth Pro... $RC"
mkdir  /opt/sherlock/google-earth && cd  /opt/sherlock/google-earth
wget https://dl.google.com/dl/earth/client/current/google-earth-pro-stable_current_amd64.deb
sudo apt install -y /opt/sherlock/google-earth/google-earth-pro-stable_current_amd64.deb
rm /opt/sherlock/google-earth/google-earth-pro-stable_current_amd64.deb
...
mkdir /opt/sherlock/yacy
cd /opt/sherlock/yacy
...
mkdir /opt/sherlock/phoneinfoga
cd /opt/sherlock/phoneinfoga
...
git clone https://github.com/evilsocket/xray.git  /opt/sherlock/XRay/
cd  /opt/sherlock/XRay/
...
git clone https://github.com/lanrat/certgraph.git  /opt/sherlock/certgraph
cd  /opt/sherlock/certgraph
make
...
git clone https://github.com/Lucksi/Mr.Holmes  /opt/sherlock/MrHolmes/
cd  /opt/sherlock/MrHolmes
python3 -m venv /opt/sherlock/MrHolmes/MrHolmes-venv
...
mkdir /opt/sherlock/spiderfoot
cd  /opt/sherlock/spiderfoot
wget https://github.com/smicallef/spiderfoot/archive/v4.0.tar.gz
tar zxvf v4.0.tar.gz
rm v4.0.tar.gz
python3 -m venv /opt/sherlock/spiderfoot/spiderfoot-venv
...
mkdir -p  /opt/sherlock/bbot/
cd /opt/sherlock/bbot/
python3 -m venv /opt/sherlock/bbot/bbot-venv
...
git clone https://github.com/opsdisk/pagodo.git  /opt/sherlock/pagodo/
cd  /opt/sherlock/pagodo/
...
git clone https://github.com/vesche/scanless  /opt/sherlock/scanless/
cd  /opt/sherlock/scanless/
...
git clone https://github.com/laramies/theHarvester.git  /opt/sherlock/theHarvester/
cd  /opt/sherlock/theHarvester
python3 -m venv /opt/sherlock/theHarvester/theHarvester-venv
...
git clone https://github.com/sherlock-project/sherlock.git  /opt/sherlock/Sherlock
cd  /opt/sherlock/Sherlock
python3 -m venv /opt/sherlock/Sherlock/Sherlock-venv
...
git clone https://github.com/s0md3v/Photon.git  /opt/sherlock/Photon/
cd  /opt/sherlock/Photon/
...
git clone https://github.com/m0rtem/CloudFail.git  /opt/sherlock/CloudFail/
cd  /opt/sherlock/CloudFail/
...
git clone https://github.com/jordanpotti/CloudScraper.git  /opt/sherlock/CloudScraper/
cd  /opt/sherlock/CloudScraper/
...
git clone https://github.com/darkoperator/dnsrecon.git  /opt/sherlock/DNSRecon/
cd  /opt/sherlock/DNSRecon/
...
git clone https://github.com/keithjjones/hostintel.git  /opt/sherlock/Hostintel/
cd  /opt/sherlock/Hostintel/
...
git clone https://github.com/The404Hacking/Infoga.git  /opt/sherlock/infoga/
cd  /opt/sherlock/infoga/
...
git clone https://github.com/GONZOsint/gitrecon.git  /opt/sherlock/gitrecon/
cd  /opt/sherlock/gitrecon/
...
mkdir -p  /opt/sherlock/ExifTool/
cd  /opt/sherlock/ExifTool/
...
git clone https://github.com/RedSiege/EyeWitness.git  /opt/sherlock/eyewitness/
cd /opt/sherlock/eyewitness
python3 -m venv /opt/sherlock/eyewitness/eyewitness-venv
source eyewitness-venv/bin/activate
cd  /opt/sherlock/eyewitness/Python/setup
sudo bash setup.sh
...
git clone https://github.com/opsdisk/metagoofil  /opt/sherlock/metagoofil/
cd /opt/sherlock/metagoofil/
python3 -m venv /opt/sherlock/metagoofil/metagoofil-venv
...
mkdir -p /opt/sherlock/osrframework/
cd /opt/sherlock/osrframework/
python3 -m venv /opt/sherlock/osrframework/osrframework-venv
...
git clone https://github.com/Quantika14/email-osint-ripper.git /opt/sherlock/eo-ripper/
cd /opt/sherlock/eo-ripper/
python3 -m venv /opt/sherlock/eo-ripper/eo-ripper-venv
...
mkdir -p /opt/sherlock/instaloader/
cd /opt/sherlock/instaloader/
python3 -m venv /opt/sherlock/instaloader/instaloader-venv
...
git clone https://github.com/mxrch/ghunt /opt/sherlock/GHunt
cd  /opt/sherlock/GHunt
python3 -m venv /opt/sherlock/GHunt/GHunt-venv
...
mkdir  /opt/sherlock/Ivre/
cd /opt/sherlock/Ivre/
python3 -m venv /opt/sherlock/Ivre/Ivre-venv
...
git clone https://github.com/DedSecInside/TorBot.git  /opt/sherlock/torbot/
cd  /opt/sherlock/torbot
python3 -m venv /opt/sherlock/torbot/torbot-venv
...
git clone https://github.com/pixelbubble/ProtOSINT.git /opt/sherlock/protosint/
cd  /opt/sherlock/protosint/
python3 -m venv /opt/sherlock/protosint/protosint-venv
